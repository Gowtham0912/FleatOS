 ...
 */
export default function PairingRequests({ isConnected, lastMessage, onRefresh }) {
      ...
      <div className="flex-1 overflow-y-auto p-6 max-w-4xl w-full mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-900">Device Pairing Requests</h2>
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold
                       bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 transition-colors cursor-pointer shadow-sm"
          >
          ...
          <div className="mb-8">
            ...
            <div className="space-y-3">
              {pendingRequests.map((req) => (
                <div
                  key={req.id}
                  className="bg-white border border-amber-200 rounded-xl p-4 shadow-sm animate-fade-in"
                >
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs text-slate-900
                                     placeholder-slate-400 focus:outline-none focus:border-blue-500 w-44"
                        />
                        <button
